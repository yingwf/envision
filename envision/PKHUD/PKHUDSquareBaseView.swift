...
public class PKHUDSquareBaseView: UIView {
    ...
    static let defaultSquareBaseViewFrame = CGRect(origin: CGPointZero, size: CGSize(width: 66.0, height: 66.0)) //156.0
    ...
    public override func layoutSubviews() {
        ...
        imageView.frame = CGRect(origin: CGPoint(x:11.0, y:11.0), size: CGSize(width: 44, height: 44)) //CGRect(origin: CGPoint(x:0.0, y:quarterHeight), size: CGSize(width: viewWidth, height: halfHeight))
