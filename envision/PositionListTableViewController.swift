...
class PositionListTableViewController: UITableViewController,UIGestureRecognizerDelegate {
...
//        backItem.tintColor = UIColor.whiteColor()
    ...
    override func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView?{
        ...
        sectionLabel.text = self.positionTitle[section]
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let positionListViewController = self.storyboard?.instantiateViewControllerWithIdentifier("PositionDetailViewController") as! PositionDetailViewController
        
        positionListViewController.webSite =  getjobInfoUrl + "?id=198" //"www.envisioncn.com"
